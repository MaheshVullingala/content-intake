    ...
    <div style={{ padding: "3rem 0", borderTop: "1px solid #F3F3F3", background: "#ffffff", width: "100%", boxSizing: "border-box", fontFamily: "'Rubik', sans-serif" }}>
      ...
      {fa_view_type === "tabs_horizontal" && fa_items.length > 0 && (
        <div>
          ...
          {fa_items[activeTab] && (
            <div>
              <h3 style={{ fontSize: 20, fontWeight: 500, color: "#181313", marginBottom: 16 }}>
                {fa_items[activeTab].title}
              </h3>
              ...
              <p style={{ fontSize: 15, color: "#3C3C3C", lineHeight: 1.75, marginBottom: 20, wordBreak: "break-word" }}>
                {fa_items[activeTab].description}
              </p>
